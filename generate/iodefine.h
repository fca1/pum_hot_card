...
#define CMPIF0 IF2_bit.no3
#define CMPIF1 IF2_bit.no4
#define CMPIF2 IF2_bit.no5
#define CMPIF3 IF2_bit.no6
#define PIF9 IF2_bit.no6
#define CMPIF4 IF2_bit.no7
#define PIF10 IF2_bit.no7
#define CMPIF5 IF2H_bit.no0
#define PIF11 IF2H_bit.no0
#define TMKBIF0 IF2H_bit.no1
#define TMKBIF1 IF2H_bit.no2
#define TMKBIF2 IF2H_bit.no3
#define TMKCIF0 IF2H_bit.no4
#define MDIF IF2H_bit.no5
#define PIF21 IF2H_bit.no6
#define PIF23 IF2H_bit.no6
#define FLIF IF2H_bit.no7
#define TMMK05 MK2_bit.no0
#define TMMK06 MK2_bit.no1
#define TMMK07 MK2_bit.no2
#define CMPMK0 MK2_bit.no3
#define CMPMK1 MK2_bit.no4
#define CMPMK2 MK2_bit.no5
#define CMPMK3 MK2_bit.no6
#define PMK9 MK2_bit.no6
#define CMPMK4 MK2_bit.no7
#define PMK10 MK2_bit.no7
#define CMPMK5 MK2H_bit.no0
#define PMK11 MK2H_bit.no0
#define TMKBMK0 MK2H_bit.no1
#define TMKBMK1 MK2H_bit.no2
#define TMKBMK2 MK2H_bit.no3
#define TMKCMK0 MK2H_bit.no4
#define MDMK MK2H_bit.no5
#define PMK21 MK2H_bit.no6
#define PMK23 MK2H_bit.no6
#define FLMK MK2H_bit.no7
#define TMPR005 PR02_bit.no0
#define TMPR006 PR02_bit.no1
#define TMPR007 PR02_bit.no2
#define CMPPR00 PR02_bit.no3
#define CMPPR01 PR02_bit.no4
#define CMPPR02 PR02_bit.no5
#define CMPPR03 PR02_bit.no6
#define PPR09 PR02_bit.no6
#define CMPPR04 PR02_bit.no7
#define PPR010 PR02_bit.no7
#define CMPPR05 PR02H_bit.no0
#define PPR011 PR02H_bit.no0
#define TMKBPR00 PR02H_bit.no1
#define TMKBPR01 PR02H_bit.no2
#define TMKBPR02 PR02H_bit.no3
#define TMKCPR00 PR02H_bit.no4
#define MDPR0 PR02H_bit.no5
#define PPR021 PR02H_bit.no6
#define PPR023 PR02H_bit.no6
#define FLPR0 PR02H_bit.no7
#define TMPR105 PR12_bit.no0
#define TMPR106 PR12_bit.no1
#define TMPR107 PR12_bit.no2
#define CMPPR10 PR12_bit.no3
#define CMPPR11 PR12_bit.no4
#define CMPPR12 PR12_bit.no5
#define CMPPR13 PR12_bit.no6
#define PPR19 PR12_bit.no6
#define CMPPR14 PR12_bit.no7
#define PPR110 PR12_bit.no7
#define CMPPR15 PR12H_bit.no0
#define PPR111 PR12H_bit.no0
#define TMKBPR10 PR12H_bit.no1
#define TMKBPR11 PR12H_bit.no2
#define TMKBPR12 PR12H_bit.no3
#define TMKCPR10 PR12H_bit.no4
#define MDPR1 PR12H_bit.no5
#define PPR121 PR12H_bit.no6
#define PPR123 PR12H_bit.no6
...
#define STDLIF4 IF1H_bit.no4
#define SRDLIF4 IF1H_bit.no5
#define SREDLIF4 IF1H_bit.no5
#define PIF20 IF1H_bit.no6
#define PIF22 IF1H_bit.no6
...
#define STDLMK4 MK1H_bit.no4
#define SRDLMK4 MK1H_bit.no5
#define SREDLMK4 MK1H_bit.no5
#define PMK20 MK1H_bit.no6
#define PMK22 MK1H_bit.no6
...
#define STDLPR04 PR01H_bit.no4
#define SRDLPR04 PR01H_bit.no5
#define SREDLPR04 PR01H_bit.no5
#define PPR020 PR01H_bit.no6
#define PPR022 PR01H_bit.no6
...
#define STDLPR14 PR11H_bit.no4
#define SRDLPR14 PR11H_bit.no5
#define SREDLPR14 PR11H_bit.no5
#define PPR120 PR11H_bit.no6
#define PPR122 PR11H_bit.no6
...
#define INTSTDL4_vect (0x3C)
#define INTSRDL4_vect (0x3E)
#define INTSREDL4_vect (0x3E)
#define INTP20_vect (0x40)
#define INTP22_vect (0x40)
...
#define INTCMP2_vect (0x4E)
#define INTCMP3_vect (0x50)
#define INTP9_vect (0x50)
#define INTCMP4_vect (0x52)
#define INTP10_vect (0x52)
#define INTCMP5_vect (0x54)
#define INTP11_vect (0x54)
#define INTTMKB0_vect (0x56)
#define INTTMKB1_vect (0x58)
#define INTTMKB2_vect (0x5A)
#define INTTMKC0_vect (0x5C)
#define INTMD_vect (0x5E)
#define INTP21_vect (0x60)
#define INTP23_vect (0x60)
