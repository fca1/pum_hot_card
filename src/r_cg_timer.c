...
void R_TMR_KB_Create(void)
{
    ...
    TKBCR21 = _0000_TMKB_DUTY21_VALUE;
    TKBCR22 = _0000_TMKB_DELAY22_VALUE;
    TKBCR23 = _0000_TMKB_DUTY23_VALUE;
...
void R_TMR_KC0_Create(void)
{
    ...
    TKCDUTY00 = _0000_TMKC_DUTY0_VALUE;
    TKCDUTY01 = _0000_TMKC_DUTY1_VALUE;
    TKCDUTY02 = _1F40_TMKC_DUTY2_VALUE;
    TKCDUTY03 = _0000_TMKC_DUTY3_VALUE;
    TKCDUTY04 = _0000_TMKC_DUTY4_VALUE;
    TKCDUTY05 = _0000_TMKC_DUTY5_VALUE;
    /* Set TKCO02 pin */
    POM20 &= 0xF7U;
    P20 &= 0xF7U;
    PM20 &= 0xF7U;
