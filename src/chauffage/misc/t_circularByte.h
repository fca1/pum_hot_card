...
#ifndef __t_circularByte
#define __t_circularByte

#include "r_cg_macrodriver.h"

#define POWER_ROTARY_BYTE     8

struct t_rotary_byte
{
	volatile uint8_t indexR :POWER_ROTARY_BYTE;
	volatile uint8_t indexW :POWER_ROTARY_BYTE;
	uint8_t  buffer[1 << POWER_ROTARY_BYTE];
};
